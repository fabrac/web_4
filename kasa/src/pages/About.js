...
import img from '../assets/images/About_Banner.jpg';
    ...
    return (
        <main>
            ...
            <div className="about_container">
                ...
                <Dropdown title='Service' text={"Nos équipes se tiennent à votre disposition pour vous fournir une expérience parfaite. N'hésitez pas à nous contacter si vous avez la moindre question."}></Dropdown>
